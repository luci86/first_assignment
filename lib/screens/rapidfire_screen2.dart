...
class RapidFireScreen20Sec extends StatefulWidget {
  @override
  State<RapidFireScreen20Sec> createState() => _RapidFireScreen20SecState();
}

class _RapidFireScreen20SecState extends State<RapidFireScreen20Sec> {
  ...
  void initState() {
    Future.delayed(Duration(seconds: 10), () {
      ...
      final loopTimer =
          Timer.periodic(const Duration(seconds: 20), (loopTimer) {
        setState(() {
          redIsVisible = false;
          greenIsVisible = true;
        });
